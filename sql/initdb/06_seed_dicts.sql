...
-- SOFT SKILLS (EN)
INSERT INTO soft_skill_dict(name) VALUES
  ('Communication'), ('Teamwork'), ('Leadership'), ('Ownership'), ('Proactivity'),
  ('Self-management'), ('Time management'), ('Critical thinking'), ('Analytical thinking'),
  ('Problem solving'), ('Adaptability'), ('Creativity'), ('Planning'),
  ('Presentation & Pitching'), ('Public speaking'), ('Negotiation'),
  ('Conflict resolution'), ('Empathy'), ('Mentorship'),
  ('Product mindset'), ('Result orientation'), ('Prioritization')
ON CONFLICT (name) DO NOTHING;
